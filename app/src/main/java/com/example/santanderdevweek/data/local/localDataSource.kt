...
class localDataSource {
    fun getLocalData() {
        ...
        return List("45454545", "252522", "4554545,55", "55457454", cliente, cartao
        )
    }

    private fun List(size: String, init: String, s: String, s1: String, cliente: Cliente, cartao: Cartao) {
